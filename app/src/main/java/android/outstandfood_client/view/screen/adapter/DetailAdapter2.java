...
public class DetailAdapter2 extends RecyclerView.Adapter<DetailAdapter2.ViewHolderDetail> {
    ...
    public DetailAdapter2(Context context, List<String> stringArrayList) {
